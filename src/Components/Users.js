...
import jon from '../images/image-jonathan.jpg';
...
const users = [
  {
    ...
    quotation: quotation,
    class: 'bg-[#7541c8] text-[#ffffff] flex-1 ',
  },
  {
    image: jon,
    ...
    class: 'bg-[#48556a] text-[#ffffff] lg:w-[250px] ',
  },
  {
    image: jean,
    ...
    class: 'bg-[#ffffff] text-[#19212e] lg:w-[250px] ',
  },
  {
    image: pat,
    name: 'Patrick Abrams',
    ...
    class: 'bg-[#19212e] text-[#ffffff] flex-1 ',
  },
  {
    image: kira,
    name: 'Kira Whittle',
    ...
    class: 'bg-[#ffffff] text-[#19212e] lg:max-w-[260px] ',
  },
];
